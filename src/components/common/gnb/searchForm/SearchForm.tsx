...
const SearchForm = () => {
  ...
  return (
    <div className='relative px-2'>
      ...
      />
      <Search className='text-gray-9fa6b2 absolute top-4 left-4 md:top-3 xl:top-4' />
      {/* X 버튼 : 사용자 의도로만 지우기 */}
      {query && (
        <button
          aria-label='검색어 지우기'
          className='text-gray-9fa6b2 absolute top-1/2 right-4 -translate-y-1/2 cursor-pointer'
          onClick={() => {
            setQuery('');
            setSugs([]);
            goHomeWithQ('');
